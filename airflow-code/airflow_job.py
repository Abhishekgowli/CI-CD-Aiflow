...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-cicd-airlines")
    bq_project = Variable.get("bq_project", default_var="ambient-glazing-458603-k8")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"airflow-project-cicd-airlines/source_{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflow-project-cicd-airlines/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "145896813811-compute@developer.gserviceaccount.com",
                "network_uri": "projects/ambient-glazing-458603-k8/global/networks/default",
                "subnetwork_uri": "ambient-glazing-458603-k8/regions/us-central1/subnetworks/default",
            }
        },
    }
